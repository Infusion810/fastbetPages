  ...
  return (
    ...
    <Box m="0.5rem 1rem" mb={4}>
      ...
      <Box
        ...
        sx={{ display: "grid", gap: 2,backgroundColor: "white", padding: 3, borderRadius: 2 }}
      >
            ...
            <TableBody>
              {filteredContacts.map((contact) => (
                <TableRow key={contact.id}>
                  ...
                  <TableCell>{contact.registrarId}</TableCell>
                  <TableCell>{contact.name}</TableCell>
                  <TableCell>{contact.email}</TableCell>
                  <TableCell>{contact.gameName}</TableCell>
                  <TableCell>Points: {contact.totalBidPoints}</TableCell>
                  <TableCell>
                    {contact.bids && contact.bids.number !== undefined ? contact.bids.number : "No Bids"}
                  </TableCell>
