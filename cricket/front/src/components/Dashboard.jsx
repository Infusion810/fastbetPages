...
const Dashboard = () => {
  ...
  const menuItems = [
    ...
    { text: 'Cricket controler', icon: <PersonIcon />, path: '/cricket/market' },
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              ...
              >
                ...
                <Typography variant="subtitle1">
                  Your one-stop solution for all cricket-related activities
                </Typography>
              </Paper>
            </Grid>
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                ...
                <Typography variant="h4">Cricket</Typography>
              </Paper>
            </Grid>
            {/* <Grid item xs={12} md={4}>
              <Paper
